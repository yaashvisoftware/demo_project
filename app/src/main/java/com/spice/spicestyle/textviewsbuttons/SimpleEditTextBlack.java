...
public class SimpleEditTextBlack extends AppCompatEditText{

    private Context context;

    public SimpleEditTextBlack(Context context) {
        super(context);
        this.context = context;
        customize();
    }

    public SimpleEditTextBlack(Context context, AttributeSet attr, int defStyle) {
        super(context, attr, defStyle);
        this.context = context;
        customize();
    }

    public SimpleEditTextBlack(Context context, AttributeSet attr) {
        super(context, attr);
        this.context = context;
        customize();
    }
